...
private ElementUtils Eu;
	...
	public String retrievePasswordWarning() {
		...
		return Eu.getTextFromElement(passwordWarning, 20);
	...
	public String retrieveTelephoneWarning() {
		...
		return Eu.getTextFromElement(telephoneWarning, 20);
...
//		return telephoneWarningText;
	...
	public String retrieveEmailWarning() {
		...
		return Eu.getTextFromElement(emailWarning, 20);
...
//		return emailWarningText;
	...
	public String retrieveLastNameWarning() {
		...
		return Eu.getTextFromElement(lastNameWarning, 20);
...
//		return lastNameWarningText;
	...
	public String retrieveFirstNameWarning() {
		...
		return Eu.getTextFromElement(firstNameWarning, 20);
...
//		return firstNameWarningText;
	...
	public String retrievePrivacyPolicyWarning() {
		...
		return Eu.getTextFromElement(privacyPolicyWarning, 20);
...
//		return privacyPolicyWarningText;
	...
	public void enterFirstName(String firstNameText) {
		...
		Eu.typeTextIntoElement(firstNameField, firstNameText, 20);
	...
	public void enterLastName(String lastNameText) {
		...
		Eu.typeTextIntoElement(lastNameField, lastNameText, 20);
	...
	public void enterEmailAddress(String emailText) {
		...
		Eu.typeTextIntoElement(emailAddressField, emailText, 20);
	...
	public void enterTelephoneNumber(String telephoneText) {
		...
		Eu.typeTextIntoElement(telephoneField, telephoneText, 20);
	...
	public void enterPassword(String passwordText) {
		...
		Eu.typeTextIntoElement(passwordField, passwordText, 20);
	...
	public void enterConfirmPassword(String passwordText) {
		...
		Eu.typeTextIntoElement(passwordConfirmField, passwordText, 20);
	...
	public void selectPrivacyPolicy() {
		...
		Eu.clickOnElement(privacyPolicyField, 20);
	...
	public AccountSuccessPage clickOnContinueButton() {
		...
		Eu.clickOnElement(continueButton, 20);
	...
	public void selectYesNewsletterOption() {
		...
		Eu.clickOnElement(yesNewsletterOption, 20);
	...
	public String retrieveDuplicateEmailAddressWarning() {
		...
		return Eu.getTextFromElement(duplicateEmailAddressWarning, 20);
